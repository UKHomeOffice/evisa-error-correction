...
Feature: EEC - E-Visa Error Correction Service Form
  ...
  Scenario Outline: E-Visa Error Correction Service form E2E test
    ...
    Examples:
       ...
       | T22: test with sponsor licence number and accompanying adult then change number of adults from 1 to 2 from check your answers |
       | T23: test with must leave uk via (flight number and airport), my problem is not listed then edit flight number and airport from check your answers |
       | T24: test with must leave uk via (flight number and airport), my problem is not listed then edit my problem is not listed from check your answers |
       | T25: test with name and email address to sign in to your account then edit email address to sign in to your account from check your answers |